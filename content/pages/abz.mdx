...
skills. This combination has several unique advantages, such as being able to
...
[**Open Sourcery**](https://opensourceryumd.com) and some business ventures.

This blend of skills, along with some financial and managerial skills, means that
I am exceptionally qualified for running teams of developers, entrepreneurship,
...
- A network of talented and motivated friends, acquaintances, and peers;
...
I have many aspirations and wants, some of which are to
...
- Build and design software that I am passionate about, for a purpose I care about besides
	chasing profits;
- Embark on entrepreneurial ventures for the sake of creating products and tools to make the world
	a better place;
...
to act on. Leveraging my skills and expanded professional network, I will
do this over and over again until one takes off. Considering that I want to
be an entrepreneur and not a corporate leader, I would try to sell the business
...
need to fall back onto something secure. Luckily, job security for software 
engineers who can learn fast and well is rather good. I'll seek to work
...
safety cushion. In class, we learned that job security is a myth nowadays, and
only those who are continuously learning and growing have any semblance of job
security. Luckily, software engineers are used to this kind of normal, as our
